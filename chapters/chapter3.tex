...
その結果，図\ref{devide_summary}のような数値を得た．いくつかの動画について，
優美なダンスでは「中部」「下部」に広く分布していることが分かった．
入力データに複数人で踊っているデータが存在していたり，そもそも精度の悪い動画も
存在しているので相関は薄く推測の域は出ないが，いくつかの動画では，
領域を大きく使っていることから手足を頻繁に使う動作が優美と判定されているように思う．
